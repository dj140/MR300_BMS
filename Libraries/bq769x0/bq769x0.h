...
class bq769x0 {
  ...
  public:
    ...
    int thermistorBetaValue  ;  // typical value for Semitec 103AT-5 thermistor

    // indicates if a new current reading or an error is available from BMS IC
	  bool alertInterruptFlag ;   // init with true to check and clear errors at start-up   
